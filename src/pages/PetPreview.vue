...
function getLevelColor(level: number): string {
  const colors: Record<number, string> = { 1: 'from-gray-400 to-gray-500', 2: 'from-gray-400 to-slate-500', 3: 'from-blue-400 to-cyan-500', 4: 'from-cyan-400 to-teal-500', 5: 'from-purple-400 to-violet-500', 6: 'from-pink-400 to-rose-500', 7: 'from-rose-400 to-red-500', 8: 'from-yellow-400 via-amber-400 to-orange-500' }
...
function selectPet(petId: string) { selectedPet.value = petId; selectedLevel.value = 1 }
